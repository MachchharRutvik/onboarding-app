...
import { personalDetailsValidation } from "../../../validation/ValidationSchema";
...
function PersonalDetails({handleNext,handleBack,steps,activeStep,isPersonalDetailsValid,setPersonalDetailsData,personalDetailsData}) {
  ...
  useEffect(() => {
    if(personalDetailsData!=null){
      ...
      setProfilePhoto(URL.createObjectURL(personalDetailsData.profilePicture))
    }
