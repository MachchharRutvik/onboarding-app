...
export const UploadDocumentsSchema = Yup.object().shape({
  educationCertificates: Yup.array().of(
    Yup.object().shape({
  ...
  latestExperienceLetter: Yup.mixed().required(
    "Latest experience letter is required"
  ),
  latestRelievingLetter: Yup.mixed().required(
    "Latest relieving letter is required"
  ),
